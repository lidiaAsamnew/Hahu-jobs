  ...
  <div class="bg-[#F0F5F7]">
    <section class="text-center pt-12 pb-20 px-4">
      <div class="container mx-auto">
        ...
        <p class="text-sm font-bold text-gray-600 mt-2 mb-8">Find career opportunities in Ethiopia</p>
         <div class="flex justify-center">
            <div class="relative">
              ...
              <input
                ...
                class="py-3 pl-10 pr-4 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                style="min-width: 300px;"
              />
            </div>
            <button
              class="ml-2 px-6 py-3 bg-teal-500 text-white rounded-r-md hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50"
            >
              Find Job
            </button>
         </div>
    ...
    <section class="py-8 bg-[#F0F5F7] px-4">
        <div class="container mx-auto">
          <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-800">Career sectors</h2>
            <p class="text-gray-600 mt-2 max-w-3xl mx-auto">Based on the local labor market trend in Ethiopia we categorize our vacancies into fourteen sectors</p>
          </div>
          ...
          <div v-else-if="sectors" class="flex flex-wrap justify-center gap-6">
            <div v-for="sector in sectors" :key="sector.id" class="w-full sm:w-1/3 md:w-1/4 lg:w-[15%]">
    ...
    <section class="bg-teal-50 py-8 pr-5 pl-14 ">
      <div class="flex py-3 max-w-7xl mx-auto gap-24">
        <div class="flex-1 bg-red-50 flex justify-center items-center w-[300px] h-[500px] ">
          <img src="/image.svg" alt="Hahu" class="w-[85%] mb-4" />
        </div>
        <div class="flex-1">
          <h1 class="text-4xl font-bold pb-4">Post vacancy</h1>
          <p class="text-sm">HaHuJobs offers dedicated enterprise cloud services for a full human resource management platform with an affordable price package. 
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-7 mt-8">
            <div class="">
              ...
              <p class="text-sm">You contact us through one of our outlets with the details of your vacancy. You can click the button below to review ways to share your vacancy and review the required information we need to publish your vacancy on all our outlets.</p>
            </div>
            <div>
              ...
              <p class="text-sm">Our service officers will receive the details from your organization via the channel you communicated it in. They will review the details provided to validate all required information is available and build validate the legitimacy of the vacancy.</p>
            </div>
            <div>
              ...
              <p class="text-sm">All vacancy details will then go through our standardized categorization process for taxonomy identification and reorganization of information if required so it fits the publishing structure of our outlets, then will be approved for publishing.</p>
            </div>
    ...
    <div class="py-10 bg-gray-100">
      ...
      <div class="flex justify-center items-center gap-20 py-8">
        <div class="text-center">
