<template>
  ...
  <div class="group relative bg-white rounded-lg shadow-md hover:shadow-sm transition-shadow duration-300 text-left  hover:border-2 hover:border-teal-600 flex flex-col h-full dark:bg-slate-700">
    ...
    <div class="flex justify-center py-5">
      <div class="inline-flex items-center gap-x-2 bg-teal-600 text-white text-sm font-semibold px-2 py-1 rounded-full dark:text-gray-50">
    ...
    <div class="flex justify-between items-center px-6 pb-4 text-gray-500 text-sm dark:text-gray-50">
      ...
      <button class="hover:text-teal-600 dark:text-gray-50">
        <Icon name="uil:share-alt" class="h-5 w-5" />
      </button>
    </div>
